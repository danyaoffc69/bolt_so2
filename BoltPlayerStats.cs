...
namespace Axlebolt.Bolt.Stats
{
	public class BoltPlayerStats
	{
		...
		{
			List<StorePlayerStat> list = new List<StorePlayerStat>();
			foreach (KeyValuePair<string, StorePlayerStat> changedStat in _changedStats)
			{
