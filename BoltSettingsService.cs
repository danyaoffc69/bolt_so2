...
{
	public class BoltSettingsService : BoltService<BoltSettingsService>
	{
		...
		public BoltSettingsService()
		{
			_settings = new Dictionary<string, GameSetting>();
			_gameSettingsRemoteService = new GameSettingsRemoteService(BoltPlayerApi.Instance.ClientService);
		}
